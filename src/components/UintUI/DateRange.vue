<template>
  <div class="smart-daterange" :class="[ui.uiStatic.item, item]" @click.stop="ui.uiEvents.click">
...
import { PhCalendar, PhXCircle, PhQuestion, PhAsterisk } from '@phosphor-icons/vue'
...
const dynamicIcon = config.value.clear ? PhXCircle : PhCalendar
